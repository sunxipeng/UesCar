...
public class RotateLoading extends View {
    ...
    private void initView(Context context, AttributeSet attrs) {
        int color = Color.rgb(240,101,101);
        ...
        if (null != attrs) {
            ...
            color = typedArray.getColor(R.styleable.RotateLoading_loading_color, Color.rgb(240,101,101));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(Color.rgb(240,101,101));
